...
class LCWANoThrowSamplerTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.entity_sampler = kgekit.LCWANoThrowSampler(cls.triple_indexes, 5, 2, 2, 0, kgekit.LCWANoThrowSamplerStrategy.Hash)
        cls.relation_sampler = kgekit.LCWANoThrowSampler(cls.triple_indexes, 5, 2, 0, 1, kgekit.LCWANoThrowSamplerStrategy.Hash)
        cls.combined_sampler = kgekit.LCWANoThrowSampler(cls.triple_indexes, 5, 2, 1, 1, kgekit.LCWANoThrowSamplerStrategy.Hash)
