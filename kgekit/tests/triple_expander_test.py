...
class TripleExpanderTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.batch = [kgekit.TripleIndex(1,0,2), kgekit.TripleIndex(0,1,2)]
        cls.num_entity = 3
        cls.num_relation = 2

    def test_expand_triple_batch(self):
        expand1, splits1 = kgekit.expand_triple_batch(self.batch, self.num_entity, self.num_relation, True, True)
        ...
        expand2, splits2 = kgekit.expand_triple_batch(self.batch, self.num_entity, self.num_relation, False, True)
        ...
        expand3, splits3 = kgekit.expand_triple_batch(self.batch, self.num_entity, self.num_relation, True, False)
        ...
        expand4, splits4 = kgekit.expand_triple_batch(self.batch, self.num_entity, self.num_relation, False, False)
